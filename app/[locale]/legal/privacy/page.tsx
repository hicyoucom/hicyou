        ...
        <div className="mx-auto max-w-4xl space-y-8 py-12">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            <section className="space-y-4">
              ...
              <p>
                Hi Cyou ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains 
            ...
            <section className="space-y-4">
              ...
              <p>
                For aggregate usage analytics we use a self-hosted Matomo instance configured to run
                <strong> without cookies</strong>, and Google Analytics. These collect anonymized
                usage data (such as pages viewed) to help us improve the service.
              </p>
            </section>
