          ...
          <div className="mx-auto max-w-4xl space-y-8 py-12">
            ...
            <div className="prose prose-gray max-w-none space-y-6 dark:prose-invert">
              ...
              <section className="space-y-4">
                ...
                <p>
                  For aggregate usage analytics we use a self-hosted Matomo
                  instance configured to run
                  <strong> without cookies</strong>, and Google Analytics. These
                  collect anonymized usage data (such as pages viewed) to help
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc space-y-2 pl-6">
                  <li>
                    <strong>Public Display:</strong> Information you submit
                    (such as website URLs and descriptions) will be publicly
                    displayed on our directory
                  </li>
                  <li>
              ...
              <section className="space-y-4">
                ...
                <p>
                  ...
                  content of these third parties. We encourage you to read the
              ...
              <section className="space-y-4">
                ...
                <p>
                  ...
                  Protection Regulation (GDPR). We aim to take reasonable steps
              ...
              <section className="space-y-4">
                ...
                <p>
                  ...
                  privacy practices, please contact us through our website or
                  repository.
                </p>
              </section>
            </div>
